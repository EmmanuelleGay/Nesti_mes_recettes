...
public class ShoppingCartAdapter extends ArrayAdapter<Ingredient> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        ...
        if(convertView==null){
            result = LayoutInflater.from(getContext()).inflate(R.layout.line_shopping_cart, parent,false);
        }
    ...
    //    TextView nameIngredient = result.findViewById(R.id.line_cart_txtView_ingredient);
     //   nameIngredient.setText(ingredient.getName());
        ...
        CheckedTextView checkedTextView = (CheckedTextView)result.findViewById(R.id.line_cart_checkedTextView);
