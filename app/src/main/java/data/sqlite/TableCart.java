...
public class TableCart extends ConnectionBdd {
    ...
    public long insertItem(Ingredient item){
      ...
      //on lui ajoute une valeur associée à une clé (qui est le nom de la colonne dans laquelle on veut mettre la valeur)
        values.put(COL_ID, item.getIdIngredient());
    ...
    public int updateById(Ingredient item){
        ...
        return this.getBDD().update(TABLE_CART, values, "id=" + item.getIdIngredient(), null);
